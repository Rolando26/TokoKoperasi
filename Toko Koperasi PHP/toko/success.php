...
?> 	 
		...
		<thead> 
			...
			<tbody> 
		 <?php
		 	$user = mysql_fetch_object(mysql_query("SELECT*FROM user where email='$_SESSION[iam_user]'"));
			$pes = mysql_fetch_array(mysql_query("SELECT*FROM pesanan where user_id='$user->id' order by id DESC limit 1"));
		...
		<a href="Struk.php" id=button class="btn btn-info btn-sm" role="button">Struk Pembayaran</a>
