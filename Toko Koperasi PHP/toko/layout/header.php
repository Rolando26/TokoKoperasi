    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Toko SMK Cinta Kasih Tzu Chi</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>">Home</a></li>
            <li><a href="<?php echo $url ?>menu.php">Pilihan Jasa</a></li> 
      ...
      <?php 
        $iamuser = $_SESSION['iam_user'];
        $users = mysql_query("SELECT * FROM user WHERE email='$iamuser'");
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/cap1.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/cap2.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div> 
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'assets/img/cap1.jpg'; ?>" width="100%"><br><br>
				<img src="<?php echo $url.'assets/img/cap2.jpg'; ?>" width="100%">
			</div>
		</div>